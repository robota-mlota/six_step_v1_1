...
#define BEMF_ON_SENSING_DIVIDER              2.25 /*!< BEMF voltage divider during PWM ON time
                                                   for zero crossing detection */
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR             0.4444444444444444 /*!< It expresses how
                                                      much the Vbus is attenuated
                                                      before being converted into
                                                      digital value */
#define NOMINAL_BUS_VOLTAGE_V                11U
