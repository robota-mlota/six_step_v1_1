...
#define SPEED_TIMER_CONV_FACTOR             (uint32_t) ((10 * SYSCLK_FREQ / (POLE_PAIR_NUM * (LF_TIMER_PSC + 1))) * SPEED_UNIT/ U_RPM)
...
#define LFTIM_PERIOD_CYCLES                    (uint16_t)(((uint32_t)SYSCLK_FREQ \
                                             / ((uint32_t)(PWM_FREQUENCY))) & (uint16_t)0xFFFE)
/**********************/
/* MOTOR 1 ADC Timing */
/**********************/
...
#define SAMPLING_CYCLE_CORRECTION           0.5 /* Add half cycle required by STM32G071RBTx ADC */
